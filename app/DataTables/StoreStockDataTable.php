...
class StoreStockDataTable extends DataTable
{
    use DatatableHelper;
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('total_qty', function(Sparepart $row) { return $row->total_qty; })
    ...
    {
        return $model->newQuery()->filter()->with(['model','storeStock']);
    }
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('total_qty')->title('الكمية'),
